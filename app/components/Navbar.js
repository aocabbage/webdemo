...
export default function Navbar() {
  return (
    <nav className="fixed z-10 left-0 top-0 right-0 sm:top-4 sm:left-4 sm:right-4 border border-secondary-600 w-auto top-0 bg-secondary-600 text-primary-50 sm:rounded-lg" >
